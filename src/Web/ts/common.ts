    ...
    export class CommonEvent {
        ...
        public static setChangedataEvent(datalist) {
            ...
            for (let key in datalist) {
                ...
                $targetBox.on('change', CommonEvent.getClassKey(column_name), { data: data }, async (ev) => {
        ...
        */
        ...
        private static addFieldEvent() {
            ...
            if (!(window as any).__exment_datepicker_lazy_init) {
                ...
                $(document)
                    ...
                    .on('click.exmentDtpLazy', '[data-add-date], input[data-column_type="date"]', function (this: any) {
                        try {
            ...
            if (typeof $.fn.datetimepicker === 'function') {
                ...
                if (!(window as any).__exment_datetimepicker_body_fix) {
                    ...
                    $(document)
                        ...
                        .on('mousedown.exmentDtpPrep pointerdown.exmentDtpPrep touchstart.exmentDtpPrep focusin.exmentDtpPrep', '[data-add-date], input[data-column_type="date"], .input-group .input-group-addon, .input-group .btn', function (this: any, e: any) {
                            try {
                                var $src = $(this);
                ...
                var initTargets = [];
                $('[data-add-date], input[data-column_type="date"]').filter(function (this: any) {
                ...
                $(initTargets).not('.added-datepicker').each(function (index: any, elem: any) {
                    var $elem = $(elem);
            ...
            $('[data-add-icheck]').not('.added-icheck').each(function (index: any, elem: any) {
        ...
        public static getParentRow($query) {
        ...
        public static getClassKey(key, prefix = '') {
