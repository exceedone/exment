...
namespace Exment {
    export class ModalEvent {
         ...
         * @param ev 
         */
        private static appendSelectItemEvent(ev){
         ...
         * @param ev 
         */
        private static deleteSelectItemEvent(ev){
        ...
        private static replaceTemplate( content, data ){
        ...
        private static setCalledSelectItemEvent(ev){
            ev.preventDefault();
