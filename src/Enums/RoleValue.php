...
class RoleValue extends EnumBase
{
    ...
    public const AVAILABLE_ACCESS_CUSTOM_VALUE = [self::CUSTOM_VALUE_EDIT_ALL, self::CUSTOM_VALUE_VIEW_ALL, self::CUSTOM_VALUE_ACCESS_ALL, self::CUSTOM_VALUE_EDIT, self::CUSTOM_VALUE_VIEW, self::PLUGIN_ACCESS];
