...
class SystemColumn extends EnumBase
{
    ...
    protected static $options = [
        'id' => ['id' => 1, 'name' => 'id', 'sqlname' => 'id', 'default' => true, 'order' => 1, 'header' => true, 'summary' => true, 'min_width' => 30, 'max_width' => 100, 'grid_filter' => true],
        ...
        'created_at' => ['id' => 96, 'type' => 'datetime', 'name' => 'created_at', 'sqlname' => 'created_at', 'default' => true, 'order' => 81, 'footer' => true, 'summary' => true, 'min_width' => 100, 'max_width' => 300, 'grid_filter' => true],
        'updated_at' => ['id' => 97, 'type' => 'datetime', 'name' => 'updated_at', 'sqlname' => 'updated_at', 'default' => true, 'order' => 82, 'footer' => true, 'summary' => true, 'min_width' => 100, 'max_width' => 300, 'grid_filter' => true],
        ...
        'workflow_status' => ['id' => 201, 'type' => 'workflow', 'name' => 'workflow_status', 'tagname' => 'workflow_status_tag', 'sqlname' => 'workflow_status_to_id', 'default' => false, 'grid_filter' => true],
        'workflow_work_users' => ['id' => 202, 'name' => 'workflow_work_users', 'tagname' => 'workflow_work_users_tag', 'default' => false, 'grid_filter' => true],
    ];
