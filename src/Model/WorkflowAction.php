...
class WorkflowAction extends ModelBase
{
    ...
    public function getWorkTargetsAttribute()
    {
        ...
        $keys = ['work_target_type', 'get_by_userinfo_base'];
        foreach ($keys as $key) {
    ...
    public function hasAuthority($custom_value, $targetUser = null)
    {
        ...
        // ignore WorkflowWorkTargetType::FIX
        if($this->getOption('work_target_type') != WorkflowWorkTargetType::FIX){
        ...
        // Ignore WorkflowWorkTargetType::GET_BY_USERINFO.
        if($this->getOption('work_target_type') != WorkflowWorkTargetType::GET_BY_USERINFO){
     ...
     */
    public function getAuthorityTargets($custom_value, $orgAsUser = false, $getAsDefine = false, $getAutorities = true, $getValueAutorities = true, bool $asNextAction = false)
    {
    ...
    protected function getNextActionAuthorities($custom_value, $statusTo, $nextActions = null)
    {
        ...
        $nextActions->each(function ($workflow_action) use (&$toActionAuthorities, $custom_value) {
            ...
            $toActionAuthorities = $workflow_action->getAuthorityTargets($custom_value, false, false, !$is_select, false, true)
