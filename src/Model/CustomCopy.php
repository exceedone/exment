...
class CustomCopy extends ModelBase implements Interfaces\TemplateImporterInterface
{
    ...
    //     $from_custom_table_id = CustomTable::getEloquent(array_get($json, 'from_custom_table_name'))->id ?? null;
    //     $to_custom_table_id = CustomTable::getEloquent(array_get($json, 'to_custom_table_name'))->id ?? null;

    //     $json['from_custom_table_id'] = $from_custom_table_id;
    //     $json['to_custom_table_id'] = $to_custom_table_id;
        
    //     // if set suuid in json, set suuid(for dashbrord list)
    //     if (!array_key_value_exists('suuid', $json)) {
    //         $json['suuid'] = short_uuid();
    //     }
