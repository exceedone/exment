...
class Define
{
    ...
    public const SYSTEM_SETTING_NAME_VALUE = [
        ...
        'system_mail_host' => ['config' => 'mail.host', 'group' => 'initialize'],
        'system_mail_port' => ['config' => 'mail.port', 'group' => 'initialize'],
        'system_mail_username' => ['config' => 'mail.username', 'group' => 'initialize'],
        'system_mail_password' => ['type' => 'password', 'config' => 'mail.password', 'group' => 'initialize'],
        'system_mail_encryption' => ['config' => 'mail.encryption', 'group' => 'initialize'],
