...
/**
 * Class RelationTableForm.
 *
 * @method Field\RelationTableItem        tableitem($column, $label = '')
 */
class RelationTableForm
{
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if ($field instanceof \Exceedone\Exment\Form\Field\RelationTableItem) {
                continue;
            }
    ...
    public function getTemplateHtmlAndScript()
    {
        ...
        foreach ($this->fields() as $field) {
            ...
            // skip when "RelationTableItem" then continue
            if ($field instanceof \Exceedone\Exment\Form\Field\RelationTableItem) {
                continue;
            }
