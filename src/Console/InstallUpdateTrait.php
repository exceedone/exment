...
trait InstallUpdateTrait
{
    ...
    {
        $this->call('vendor:publish', ['--provider' => \Exceedone\Exment\ExmentServiceProvider::class, '--tag' => 'open-admin-lang-exment', '--force' => true]);
        $this->call('vendor:publish', ['--provider' => \Exceedone\Exment\ExmentServiceProvider::class, '--tag' => 'open-admin-assets-exment', '--force' => true]);
