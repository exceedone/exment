...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Whether use exment Chatbot.
    |
    */
    'chatbot' => env('EXMENT_CHATBOT', false),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | API key for Exment AI server.
    |
    */
    'ai_server_api_key' => env('EXMENT_AI_SERVER_API_KEY', env('AI_SERVER_API_KEY')),
