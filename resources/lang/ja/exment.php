...
return [
    ...
    'workflow' => [
        ...
        'help' => [
            ...
            'enabled_flg' => 'ワークフローで、この状態を有効にする場合に、YESを設定してください。',
            'status_name' => '画面に表示するときの名称を設定します。',
            'editable_flg' => 'ワークフローがこの状態のときに、ユーザーが対象のデータを編集できるかどうかを設定します。この状態になったデータを編集させたくない場合は、NOに設定してください。',
        ],
        'message' => [
