...
return [
    ...
    'system' => [
        ...
        'filter_joined_organization' => 'ユーザー・組織のフィルター',
        ...
        'filter_joined_organization_options' => [
            'not_filter' => '絞り込みを行わない',
            'all' => 'ログインユーザーが所属する組織と、親子階層の組織ならびに所属ユーザー',
            'only_upper' => 'ログインユーザーが所属する組織と、親階層の組織ならびに所属ユーザー',
            'only_downer' => 'ログインユーザーが所属する組織と、子階層の組織ならびに所属ユーザー',
            'only_join' => 'ログインユーザーが所属する組織ならびに所属ユーザー',
        ],
        ...
        'help' =>[
            ...
            'filter_joined_organization' => 'システム管理者以外のログインユーザーが、他のユーザー・組織を表示できる範囲を設定します。※複数の会社をまたいで利用するポータルサイトなど、他のユーザー情報を表示させたくない場合に設定してください。',
