...
return [    
    ...
    'backup' => [
        ...
        'backup_automatic_target' => 'バックアップ対象',
        ...
        'help' =>[
            ...
            'backup_automatic_target' => 'バックアップの対象です。特に理由がない限り、すべての項目にチェックを入れることをおすすめします。',
            'enable_automatic' => 'ONにした場合、自動的にバックアップを実行します。',
            'automatic_term' => '自動バックアップを何日おきに実施するかの設定です。例：「3」と入力時、3日おきにバックアップ実行',
            'automatic_hour' => '自動バックアップを開始時間です。例：「3」と入力時、3:00にバックアップ実行開始',
        ]
    ],
