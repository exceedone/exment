...
return [
    ...
    'workflow' => [
        ...
        'help' => [
            ...
            'work_targets2' => 'このアクションを実行できるユーザーの種類を選択します。<br />「前アクションの実行ユーザーが選択」は、前のアクションを実行したユーザーが、このアクションを実行できます。「事前に設定」は、特定のユーザーや組織のみ実行できます。',
            ...
            'reject_action' => '「却下」「差し戻し」など、前のステータスに戻るアクションの場合、チェックを行ってください。',
        ],
