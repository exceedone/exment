...
return [
    ...
    'system' => [
        ...
        'help' =>[
            ...
            'system_mail_from_view_name' => '送信元の表示名を入力してください。受信者に表示されます。※通知テンプレートで、送信元の表示名を入力していた場合は、その設定が優先されます。',
    ...
    'custom_form_public' => [
        ...
        'help'=> [
            ...
            'header_logo' => 'ヘッダーのロゴを指定してください。推奨サイズ：200px * 40px / :size <br/>※現在、ヘッダーロゴは、編集中のプレビュー機能に対応していません。確認する場合、一度保存後に実施してください。',
