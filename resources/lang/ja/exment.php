...
return [
    ...
    'system' => [
        ...
        'safety_check_comment_window_minutes' => '追加回答の受付時間（分）',
        'safety_check_max_bulletin_age_minutes' => '地震履歴取得範囲（分）',
        'safety_check_resend_throttle_minutes' => '手動再送間隔（分）',
        ...
        'help' =>[
            ...
            'safety_check_auto_enabled' => 'YESの場合、自動送信する最小震度以上の地震を検知すると、通知を自動的に送信します。',
            'safety_check_min_scale' => '選択した震度（全国の最大震度）以上の地震を検知すると、通知を自動的に送信します。',
            'safety_check_cooldown_minutes' => '※同一の地震に対する再送信までの間隔です。<br/>例：同一地震の速報を02:02～02:12に受信した場合、60分設定では02:02の1回のみ送信、5分設定では02:02と02:12の2回送信されます。<br/>※別の地震の場合は、設定した間隔に関係なく送信されます。',
            'safety_check_comment_window_minutes' => '安否回答ボタンを押した後、追加回答を受付ける時間（分）',
            'safety_check_max_bulletin_age_minutes' => '「設定値10のままにしてください。通常は設定の必要はありません」',
            'safety_check_resend_throttle_minutes' => '※通知後に再通知できるまでの間隔を設定します。ここで設定した時間内は再送できません。0にすると制限しません。',
    ...
    'safety' => [
        ...
        'col_comment' => '追加回答', 'col_answered_at' => '回答日時', 'col_channel' => '回答チャネル',
