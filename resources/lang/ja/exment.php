...
return [
    ...
    'backup' => [
        ...
        'message' => [
            ...
            'restore_caution' => '別の環境に移行を行う場合、元の環境と移行先の環境の差異により、問題が発生することがあります。<br>特に、OSが異なる場合(WindowsやLinux)や、データベースの種類(MySQLやMariaDB)、バージョン等が異なる場合は、さまざまな要因により、正常に完了しないことが多いです。<br>必ず事前に、確認を行ってください。',
        ],
        'help' =>[
