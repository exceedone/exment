...
return [
    ...
    'dashboard' => [
        ...
        'dashboard_box_options' => [
            ...
            'chart_type_lock' => 'チャートの種類を固定する',
            'chart_type_lock_help' => '有効にすると、ダッシュボード上でチャートの種類を切り替えるセレクトボックスを表示しません。',
        ...
        'filter_bar' => [
            'header' => 'ダッシュボードフィルター',
            'title' => 'フィルター',
            'description' => 'ダッシュボード上部に、全ボックス共通の絞り込みフィルターバーを表示します。フィルター元テーブルの列をフィルター項目として設定します。同じ列名を持つテーブルを使用するチャートのみ絞り込まれます。',
            ...
            'range_to' => 'まで',
            'all_values' => '（すべて）',
            'narrow_first' => '候補が多すぎます。他のフィルターで絞り込むと選択できます',
        ...
        'ai' => [
            'switch' => 'AI要約',
            'switch_help' => '有効にすると、グラフデータをAIサービスへ送信し、AIによる要約を生成します。機密性の高いデータを扱うダッシュボードでは無効にしてください。',
            'toggle' => 'AI要約',
            'generating' => '要約を生成中...',
            'regenerate' => '再生成',
            'disabled' => 'AI要約は無効です。',
            'withheld' => '機微なデータが含まれているため、このデータはAIに送信されませんでした。',
            'stat_highest' => '最大',
            'stat_lowest' => '最小',
            'stat_average' => '平均',
            'stat_range' => '幅',
            ...
            'api_error_rate' => 'AIの呼び出し回数の上限に達しました。数分後にもう一度お試しください。',
        ...
        'message' => [
            ...
            'chart_render_error' => 'このグラフを表示できませんでした（データが適していない可能性があります）。',
    ...
    'chart' => [
        ...
        'chart_type_options' => [
            ...
            'mline' => '複数折れ線グラフ（複数系列）',
            'heatmap' => 'ヒートマップ（複数系列）',
            'sarea' => '積み上げエリアグラフ（複数系列）',
            'treemap' => 'ツリーマップ（複数系列）',
            'sunburst' => 'サンバースト（複数系列）',
            'boxplot' => '箱ひげ図（複数系列）',
        ],
