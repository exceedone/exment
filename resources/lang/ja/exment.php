...
return [    
    ...
    'custom_column' => [
        ...
        'help' => [
            ...
            'init_only' => 'YESにすることで、新規作成時のみ入力可能になります。編集時は読み取り専用で表示されます。',
            ...
            'select_load_ajax' => 'YESにすることで、はじめは選択肢を読み込まず、ユーザーの入力値でデータを検索し、選択候補を絞り込みます。<br/>※この設定に関わらず、データの件数が%s件以上の場合は、自動的に都度検索設定になります。',
