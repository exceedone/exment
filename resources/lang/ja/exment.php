...
return [
    ...
    'role_group' => [
        ...
        'role_type_option_plugin' => [
            ...
            'plugin_access' => ['label' => '利用・アクセス', 'help' => 'プラグインの種類によって変わります。<br />ページの場合：該当ページにアクセスできます。<br />トリガーの場合：トリガーが有効になります。ボタンの場合は、ボタンが表示されます。'],
        ],
    ],
    ...
    'custom_value' => [
        ...
        'export' => 'エクスポート',
        'default_export' => 'エクスポート(すべてのシステム・カスタム列)',
        ...
        'help' => [
            ...
            'import' => 'インポート実行のためのダイアログを表示します。※インポートのためのデータは、「テンプレート出力」か、「エクスポート(すべてのシステム・カスタム列形式)」で出力したデータで行ってください。',
    ],
        'message' => [
