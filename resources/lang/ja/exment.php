...
return [
    ...
    'custom_column' => [
        ...
        'help' => [
            ...
            'select_item' => '改行区切りで選択肢を入力してください。半角スペース、[]"などの文字を含めると正しく検索できないことがあります。',
            ...
            'select_item_valtext' => '改行区切りで選択肢を入力します。カンマの前が値、後が見出しとなります。<br/>値部分に半角スペース、[]"などの文字を含めると正しく検索できないことがあります。<br/>例：<br/>「1,成人<br/>2,未成年」→"1"が選択時にデータとして登録する値、"成人"が選択時の見出し',
