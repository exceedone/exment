...
return [
    ...
    'workflow' => [
        ...
        'help' => [
            ...
            'get_by_userinfo_base' => 'どのユーザーを基準にして、次のアクションを実行するユーザー・組織を取得するかどうかを選択します。<br />「最初の実行ユーザー」：フローの最初のアクションを実行したユーザーを基準にします。<br />「実行ユーザー」：該当のアクションを実行したユーザーを基準にします。',
        ],
        ...
        'message' => [
            ...
            'get_by_userinfo_base_discrepancy' => '同じ実行前ステータスで、「実行ユーザー情報から取得」の「基準ユーザー」が異なる設定はできません。',
