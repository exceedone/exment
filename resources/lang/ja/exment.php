...
return [
    ...
    'system' => [
        ...
        'help' =>[
            ...
            'chatbot_faq_wf' => 'YESにすることで、FAQレビュー承認プロセス管理のワークフローを連携します。',
            'chatbot_faq_wf_status_filters' => 'チャットボット画面に表示する提案質問のステータスを指定します。改行区切りで選択肢を入力してください。<br/>目立つフラグが「YES」で、かつ上記で指定したステータスの質問のみはチャット開始の際に表示されます。',
            'chatbot_timeidle' => 'ユーザからの反応がない場合に、次のアクションを促すメッセージを表示するまでの待機時間（単位：分）を設定します。',
