...
return [
    ...
    'workflow' => [
        ...
        'help' => [
            ...
            'work_target_type' => 'このアクションを実行できるユーザーの種類を選択します。<br />「全ユーザー実行可能」は全員が実行でき、「事前に設定」は、特定のユーザーや組織のみ実行できます。',
            'work_target_type2' => 'このアクションを実行できるユーザーの種類を選択します。<br />「前アクションの実行ユーザーが選択」は、前のアクションを実行したユーザーが、このアクションを実行できます。「事前に設定」は、特定のユーザーや組織のみ実行できます。',
    ...
    'role_group' => [
        ...
        'role_type_option_master' => [
            ...
            'custom_value_import' => ['label' => 'インポート', 'help' => 'データをインポートすることができます。<br />※この権限の他に、編集権限が必要です。'],
            'custom_value_export' => ['label' => 'エクスポート', 'help' => 'データをエクスポートすることができます。<br />※出力データは、ユーザーが閲覧することができるデータに限ります。'],
        ], 
