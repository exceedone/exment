...
return [
    ...
    'system' => [
        'attach_file' => '添付ファイル',
        'currently_delete_title' => '処理中',
        'currently_delete_text' => '削除してます。しばらくお待ちください。',
        'delete_success_text' => '削除は終わりました。',
        'cancel' => 'キャンセル',
        'log_menu' => 'アクセスログ',
        'delete_log_text' => 'ログ保存期間外のログデータがあります。削除してもいいですか？',
        'delete_log_title' => 'ログ削除',
        'day' => '日間',
        'month' => '月間',
        'year' => '年間',
        ...
        'log_available' => 'アクセスログ管理機能を利用する',
        'time_clear_log' => 'ログ保存期間',
        ...
        'help' =>[
            ...
            'log_available' => 'YESにした場合、LOGを使用することができます。',
            'time_clear_log' => 'ログ保存期間',
    ...
    'custom_table' => [
        ...
        'help' => [
            ...
            'log_enabled' => 'YESにした場合、検索画面から検索可能になります。',
