...
return [
    ...
    'error' => [
        ...
        'invalid_zip_entry' => 'ZIPファイルに許可されていないファイルパスが含まれています。該当のエントリ名はエラーログに出力されています。削除してから再度アップロードしてください。',
    ...
    'system' => [
        ...
        'meili' => 'Meilisearch（全文検索）設定',
        'meili_host' => 'Meilisearch ホスト',
        'meili_key' => 'マスター API キー',
        'meili_index' => 'インデックス名',
        'meili_global_search' => 'Meilisearch でグローバル検索を有効化',
        'meili_realtime_sync' => 'インデックスのリアルタイム同期',
        'meili_batch_size' => 'バッチサイズ（インデックス時）',
        'meili_repair_enabled' => 'インデックス定期修復',
        'meili_repair_at' => '修復実行時刻 (HH:MM)',
        'meili_filter_mode' => '検索フィルターの列選択',
        'meili_filter_mode_options' => [
            'override' => '自動 ＋ カスタム',
            'manual' => 'カスタムのみ',
        ],
        'meili_filter_alias' => 'エイリアス（統合キー）',
        'meili_filter_type' => 'フィルタ種別',
        'meili_filter_type_options' => [
            'equality' => '一致（ステータス・区分など）',
            'range' => '範囲（数値・日付など）',
        ],
        'meili_filter_include_mode' => '追加/除外',
        'meili_filter_include_mode_options' => [
            'include' => '追加（この列をフィルタに追加）',
        ...
        'meili_filter_column_invalid' => '選択した列は、このテーブルでフィルタに使用できません。テーブルを選び直してから列を選択してください。',
        'meili_dictionary' => '検索辞書（類義語・ストップワード）',
        'meili_dictionary_type' => '種別',
        'meili_dictionary_type_synonym' => '類義語',
        'meili_dictionary_type_stopword' => 'ストップワード',
        'meili_dictionary_word' => '単語',
        'meili_dictionary_synonyms' => '類義語（カンマ・改行区切り）',
        ...
        'help' =>[
            ...
            'meili_host' => '例: http://127.0.0.1:7700',
            'meili_key' => 'Meilisearch サーバーのマスター API キーです。暗号化して保存されます。空欄で保存すると空のキーが保存され、.env の MEILISEARCH_KEY が使用されます。',
            'meili_index' => '統合インデックス名（例: exment_global）。変更後は `php artisan exment:meili-index` で再構築してください。',
            ...
            'meili_dictionary_type' => '「類義語」＝同義として扱う語のグループ。「ストップワード」＝検索時に無視する語（助詞など）。',
            'meili_dictionary_word' => '類義語＝グループの代表語。ストップワード＝無視する語（カンマ・改行で複数可）。',
            'meili_dictionary_synonyms' => '代表語と同義とみなす語をカンマまたは改行で入力（例: contract, agreement）。相互に同義語となります。',
            'meili_filter_alias' => '同じ意味の列（例: status と contract_status）に同じエイリアスを設定すると、1つのフィルタグループに統合されます。一致フィルタのみ対象。変更時は保存すると自動で再インデックスされます。',
            'meili_filter_include_mode' => '追加: この列をフィルタに追加します。除外: 自動対象の列をフィルタから外します（「自動 ＋ カスタム」モードのみ有効）。',
    ...
    'search' => [
        ...
        'filter_unavailable' => '検索エンジンで絞り込み条件を適用できなかったため、結果を表示できません。条件を解除するか、しばらくしてから再度お試しください。',
        'sort_unavailable' => '検索エンジンを利用できないため、並び順は適用されていません。',
        'partial_results' => '該当件数が多いため、閲覧可能なデータの一部のみ表示されている可能性があります。左の「作成ユーザー」でご自身を選択するか、キーワードや絞り込み条件を追加してください。',
        'reindex_skipped' => '設定は保存しましたが、対象テーブルのデータ件数が多く、キュー接続が sync のため検索インデックスは更新されていません。コマンド「php artisan exment:meili-index」を実行してください。',
        'sort_relevance' => '関連度順',
        'sort_newest' => '新しい順',
        'sort_oldest' => '古い順',
        'filter_more' => '他 %s 件…',
        'saved_name_invalid' => '名前を入力してください（最大100文字）。',
        'share_targets_invalid' => '共有先を選択してください（所属しているロールグループ・組織のみ選べます）。',
        'share_all_denied' => '全員への共有はシステム管理者のみ行えます。',
        'saved_limit_reached' => '保存できる検索条件は %d 件までです。不要なものを削除してから保存してください。',
        'range_min' => '下限',
        'range_max' => '上限',
        'result_unit' => '件',
        'saved_search' => '保存した検索',
        ...
        'saved_prompt_name' => '保存名を入力してください',
        'saved_dropped' => '保存時の条件の一部が無効になったため除外されました',
        'saved_with_keyword' => '検索キーワードも一緒に保存する',
        'saved_share_scope' => '共有範囲',
        'share_personal' => '自分のみ',
        'share_all' => 'すべてのユーザー',
        'share_role_group' => 'ロールグループ',
        'share_organization' => '組織',
    ],
    ...
    'menu' => [
        ...
        'system_definitions' => [
            'home' => 'HOME',
            'system' => 'システム設定',
            'meili_filter' => '検索フィルター設定',
            'meili_dictionary' => '検索辞書設定',
            'plugin' => 'プラグイン',
            'custom_table' => 'カスタムテーブル',
            'role_group' => '役割グループ',
            'menu' => 'メニュー',
