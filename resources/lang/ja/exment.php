...
return [
    ...
    'workflow' => [
        ...
        'help' => [
            ...
            'get_by_userinfo_base' => 'アクション設定の実行可能ユーザーが「実行ユーザー情報から取得」の場合、どのユーザーを基準にして、次のアクションを実行するユーザー・組織を取得するかどうかを選択します。<br />「最初の実行ユーザー」：フローの最初のアクションを実行したユーザーを基準にします。<br />「実行ユーザー」：該当のアクションを実行したユーザーを基準にします。',
        ],
