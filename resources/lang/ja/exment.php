...
return [
    ...
    'system' => [
        ...
        'system_line' => 'LINE設定',
        'system_line_channel_token' => 'チャネルアクセストークン',
        'system_line_channel_secret' => 'チャネルシークレット',
        'system_line_oa_basic_id' => 'LINE公式アカウント Basic ID',
        'system_line_webhook_url' => 'Webhook URL',
        'safety_check' => '安否確認設定',
        'safety_check_auto_enabled' => '地震発生時に自動送信する',
        'safety_check_min_scale' => '自動送信する最小震度',
        'safety_check_cooldown_minutes' => '再送信までの間隔（分）',
        'safety_check_comment_window_minutes' => 'コメント受付時間（分）',
        'safety_check_max_bulletin_age_minutes' => '地震情報の有効時間（分）',
        'safety_check_resend_throttle_minutes' => '再送の間隔制限（分）',
        'safety_check_index_limit' => '管理画面の表示件数',
        ...
        'help' =>[
            ...
            'system_line_oa_basic_id' => 'LINE公式アカウントの Basic ID（@から始まる）。連携用ディープリンクの生成に使用します。',
            'safety_check_auto_enabled' => 'YESにした場合、設定した震度以上の地震を検知すると、安否確認の通知を自動的に送信します。',
            'safety_check_min_scale' => '自動送信のトリガーとなる、最小の震度（全国の最大震度）を選択してください。',
            'safety_check_cooldown_minutes' => '自動送信後、同じ地震で再度送信するまでの間隔（分）を設定します。',
            'safety_check_comment_window_minutes' => '安否回答ボタンを押した後、テキストメッセージをコメントとして受け付ける時間（分）です。コメントを送るたびに延長されます。',
            'safety_check_max_bulletin_age_minutes' => '発生からこの時間（分）を超えた地震情報は、震度条件を満たしても自動送信しません。機能を有効にした直後に、過去の地震で通知が送られるのを防ぎます。',
            'safety_check_resend_throttle_minutes' => '安否確認管理画面の「再送」を、前回の再送からこの時間（分）以内は実行できないようにします。0にすると制限しません。',
            'safety_check_index_limit' => '安否確認管理画面に表示するイベントの最大件数です。',
    ...
    'notify' => [
        ...
        'flex_template_id' => 'LINE Flexテンプレート',
        'line_show_detail' => '詳細を見る',
        ...
        'help' => [
            ...
            'flex_template_id' => 'LINEに送る Flex メッセージのテンプレート。選択するとカード形式で送信します（未選択ならテキスト送信）。承認・却下ボタンは、対象テーブルにワークフローがあり受信者に実行権限がある場合のみ自動で付きます。',
    ...
    'safety' => [
        ...
        'event_table_view_name'  => '安否確認イベント',
        'answer_table_view_name' => '安否回答',
        'col_title' => 'タイトル', 'col_trigger_type' => '発動種別', 'col_event_status' => '状態',
        'col_triggered_at' => '発動日時', 'col_jma_event_id' => '地震情報ID', 'col_quake_info' => '地震情報', 'col_quake_time' => '地震発生日時',
        'col_target_count' => '対象者数', 'col_sent_count' => '送信数', 'col_resent_at' => '再送日時',
        'col_event' => 'イベント', 'col_user' => 'ユーザー', 'col_answer_status' => '安否状況',
        'col_comment' => 'コメント', 'col_answered_at' => '回答日時', 'col_channel' => '回答チャネル',
        'col_unlinked_flg' => 'LINE未連携',
        'flex_template_name' => '安否確認', 'flex_template_desc' => '安否確認送信用のシステムテンプレートです。',
        'mail_template_view_name' => '安否確認メール',
        ...
        'quake_max_scale' => '最大震度:scale',
        'status_safe' => '無事です', 'status_minor_injury' => '軽傷', 'status_need_help' => '要支援',
        'flex_note' => '補足はそのままメッセージでお送りください',
        'drill_prefix' => '【訓練】',
        'answer_done' => '「:status」を記録しました。補足があればそのままメッセージをお送りください。',
        'answer_closed' => 'この安否確認は締め切られました。',
        'comment_added' => 'コメントを追記しました。',
        'new_event_title' => '新規送信', 'col_answered_count' => '回答数',
        'trigger_type_manual' => '手動', 'trigger_type_drill' => '訓練', 'trigger_type_jma_auto' => '地震連動',
        'event_status_open' => '実施中', 'event_status_closed' => '締切済',
        'button_send' => '送信', 'button_resend' => '再送', 'button_close' => '締切',
        'confirm_resend' => '未回答者へ再送します。よろしいですか？',
        'confirm_close' => 'この安否確認を締め切ります。よろしいですか？',
        'message_send_succeeded' => '安否確認を送信しました。',
        'message_resend_succeeded' => '再送しました。',
        'message_resend_throttled' => '再送は:minutes分以上間隔をあけてから行ってください。',
