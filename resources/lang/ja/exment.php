...
return [
    ...
    'system' => [
        ...
        'chatbot_faq_wf' => 'チャットボットFAQの承認',
        'chatbot_faq_wf_status_filters' => '表示するFAQステータス',
        'chatbot_faq_wf_status_filters_default' => '承認',
        'chatbot_timeidle' => 'ユーザー未応答時の待機時間',
        ...
        'help' =>[
            ...
            'ai_assistant_available' => 'YESにすることで、AIアシスタント機能を利用できます。',
            'ai_ocr_available' => 'YESにすることで、AI OCR機能を利用できます。',
            'chatbot_available' => 'YESにすることで、チャットボットが表示され、ユーザの質問に自動で対応します。',
            'chatbot_faq_wf' => 'YESにすると、チャットボットFAQのやり取りを承認ワークフローで管理します。チャットボットはFAQテーブルに保存されてかつ、ワークフローで承認されたやり取りのみを、回答時の今後の参照情報として利用します。',
            'chatbot_faq_wf_status_filters' => 'チャットボットFAQ表示に使用する承認ステータス名を入力してください。',
            'chatbot_timeidle' => 'チャットボットからのメッセージに対してユーザーの返信がない場合に、次のアクションを促すメッセージを表示するまでの待機時間（分）を設定します。',
    ...
    'plugin' => [
        ...
        'market' => [
            ...
            'no_license' => '未購入',
            'license_valid' => '有効',
            'license_permanent' => '永続',
            'license_expiry' => '有効期限: :date',
            ...
            'license_modal' => [
                ...
                'price' => '価格',
                'license_key' => 'ライセンスキー',
                'license_key_placeholder' => 'ライセンスキーを入力してください',
                'license_key_help' => 'プラグイン購入後にマーケットからメールまたはマイページで発行されたライセンスキーを入力してください。通常、1つのライセンスキーは特定のドメインに紐づきます。',
                'version' => 'バージョン',
                'cancel' => 'キャンセル',
            ...
            'message' => [
                ...
                'uninstall_confirm_text' => 'この操作は元に戻せません。',
                'uninstall_success' => 'プラグイン":name"が正常にアンインストールされました！',
                'installing' => 'インストール中...',
                'uninstalling' => 'アンインストール中...',
                'expired_warning' => '期限切れ',
                'payment_processing' => '処理中...',
                'renew_processing' => '処理中...',
                'please_enter_license' => 'ライセンスキーを入力してください',
                'please_select_version' => 'バージョンを選択してください',
                ...
                'license_validation_failed' => 'ライセンスの検証に失敗しました',
                'invalid_license' => '無効なライセンスキーです',
                'download_failed' => 'プラグインファイルのダウンロードに失敗しました',
                'update_success' => 'プラグインが正常に更新されました',
                'install_error' => 'プラグインのインストール中にエラーが発生しました',
                'invalid_plugin_data' => '無効なプラグインデータです',
                'plugin_not_installed' => 'プラグインがインストールされていません',
                'uninstall_error' => 'プラグインのアンインストール中にエラーが発生しました',
                'payment_cancelled' => '支払いがキャンセルされました',
                'payment_failed' => '支払いに失敗しました',
                'notice_title' => 'お知らせ',
                'ok' => '確認',
                'manual_payment_required' => '自動決済・自動インストールは有料のExmentアカウントのみ利用できます。プラグインマーケットで決済し、手動でインストールしてください。',
                'missing_tenant_uuid' => 'tenant_uuid がありません。',
                ...
                'no_license_received' => '支払いゲートウェイからライセンスキーを受信できませんでした',
                'payment_success_installing' => '支払いが完了しました！プラグインをインストールしています...',
    ...
    'custom_table' => [
        ...
        'help' => [
            ...
            'ai_ocr_import_multi_alert' => 'インポートファイルに複数の結果があります。このファイルには、複数のインポート機能を使用してください',
    ...
    'ai_assistant' => [
        'header' => 'AIアシスタント',
        'description' => 'AIでexment構築や支援をする',
        'help' => '現在、AIを活用して以下の基本機能の作成をサポートしております。ご希望の機能を選択のうえ、リクエストをお送りくださいませ。',
        'notify' => 'サポートしてほしい機能を選択するにはボタンをクリックしてください。',
        'welcome_message' => '新しい:typeの作成をお手伝いさせていただきます。どうぞご依頼をお送りくださいませ。',
        'edit_message' => '編集をご希望の情報をお送りいただけますでしょうか。',
        'chat_box_placeholder' => 'ご利用ありがとうございます。こちらは AI チャットウィンドウです。新しい会話を開始すると、以前のメッセージはクリアされます。ご不明な点がございましたら、いつでもお手伝いさせていただきます。',
        'input_placeholder' => 'ご希望の内容をご入力くださいませ',
        'send_button' => '送信',
        'edit_button' => '編集',
        'create_button' => '次へ',
        'cancel_button' => 'キャンセル',
        'feature' => [
            'custom_table' => 'カスタムテーブル',
            'workflow' => 'ワークフロー',
            'schedule_notifications' => 'スケジュールおよび通知',
            'calendar' => 'スケジュール',
            'notify'   => '通知',
        ],
        'calendar_targets' => [
        ...
        'ai_response' => [
            'custom_table' => [
                ...
                'explained' => 'この内容でデータベースを作成しますか？アクションボタンをクリックしてください。',
                'suggested' => 'こちらがご提案のデータテーブルです。ご確認の上、必要に応じて修正をご依頼ください。アクションボタンをクリックしてください。',
            ...
            'workflow' => [
                'welcome' => '新しいワークフローの作成をお手伝いいたします。リクエストをお送りください。これは、これまでに作成されたカスタムテーブルのリストです（新しいテーブルのワークフローを作成する場合は、まずAIカスタムテーブルを使用してテーブルを作成してください）。',
                'workflow_exists' => '要求されたワークフローはすでに存在します。ワークフローを再度ご確認ください。',
                'request_table' => 'ワークフローを作成するために必要なデータテーブルが見つかりません。先に「カスタムテーブル」機能を使用してデータテーブルを作成してください。',
                'suggested' => 'こちらがご提案の:typeです。ご確認の上、必要に応じて修正をご依頼ください。アクションボタンをクリックしてください。',
                'confirming' => 'もう一度すべてを確認してください。、必要に応じて修正をご依頼ください。アクションボタンをクリックしてください。',
                'confirmed' => 'ワークフローが作成されました。ワークフローにアクセスして確認・編集できます。',
            ],
        ],
    ],
