...
return [
    ...
    'system' => [
        ...
        'help' =>[
            ...
            'meili_key' => 'Leave blank to keep the current key (hidden for security).',
            'meili_index' => 'Combined index name, e.g. exment_global. After changing it, run `php artisan meili:index` to rebuild.',
