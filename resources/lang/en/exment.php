...
return [
    ...
    'custom_column' => [
        ...
        'help' => [
            ...
            'grid_icon' => 'Font Awesome icon name shown in front of the value. Ex: fa-phone, fa-users. Works with every display style except "Avatar".',
            'grid_nowrap' => 'When set to YES, the text in the cell is never wrapped onto a second line.',
            'grid_value_colors' => 'Fill in to give each option its own color. One value per line, in the form "value,text color". To set the background and the border as well, write "value,text color,background color,border color". Ex: 1,#c0392b<br/>On a badge, the first color becomes the fill. On a progress bar the lines are thresholds: "threshold,color" applies the color from that value up. Ex: 75,#f39c12',
    ...
    'custom_view' => [
        ...
        'kanban_style_options' => [
            'auto' => 'Auto (label + value)',
            'text' => 'Text only',
            'tag' => 'Tag (square)',
            'pill' => 'Pill (with icon)',
            'dot' => 'Colored square + text',
            'lvl' => 'Colored circle + text',
            'state' => 'State badge (colored)',
            'chip' => 'Small chip',
            'point' => 'Point (green)',
            'flag' => 'Met / breach mark',
            'avatar' => 'Avatar (assignee)',
            'icontext' => 'Icon + text (no box)',
        ],
        ...
        'description_custom_view_kanban_columns' => 'Select the columns displayed on the card. "Position" decides where in the card they appear, "Style" decides how they look (tag, pill, colored badge and so on).<br/>*"Icon" takes a Font Awesome class name (for example fa-phone). It is used by the pill, chip and point styles.<br/>*If not set, the card shows the title only.',
        ...
        'help' => [
            ...
            'kanban_done_keys' => 'Lanes that mean "finished", picked from the values of the table.<br/>*Those records stop the deadline countdown and are counted as "Done" in the summary bar.<br/>*On a workflow board every status flagged as completed is already treated as done, so nothing has to be set here.',
            ...
            'kanban_assignee_column' => 'Column holding the assignee.<br/>*Shown with an avatar at the bottom of the card; empty cards show "Unassigned".<br/>*Also used by the summary bar, the "Unassigned only" filter and bulk assign.',
            'kanban_limit_column' => 'The deadline date column.<br/>*From the difference with now, the card shows a "left", "due soon" or "overdue" badge.<br/>*A record whose lane is treated as done shows "met" instead.',
            ...
            'kanban_drawer' => 'If YES, clicking a card opens a detail panel on the right.<br/>*If NO, it opens the record page instead.',
            'kanban_position' => 'Where inside the card this column is shown.',
            'kanban_style' => 'How this column looks inside the card.',
        ...
        'message' => [
            ...
            'preview_not_supported' => 'This view kind has no preview. It is available for the data list and the kanban board.',
