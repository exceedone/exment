...
return [
    ...
    'custom_column' => [
        ...
        'help' => [
            ...
            'select_item' => 'Enter choices by line break separator.If you include characters such as half-width spaces or []", the search may not work properly.',
            ...
            'select_item_valtext' => 'Enter choices by line break separator. The word before the comma is the value, the word after the comma is the label. <br/>If the value contains characters such as half-width spaces or "[], the search may not work properly.<br/>Ex：「1,Adult<br/>2,Underage」→"1" is the value saving data. "Adult" is the label user selected.',
