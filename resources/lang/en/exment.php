...
return [
    ...
    'error' => [
        ...
        'invalid_zip_entry' => 'The ZIP file contains a file path that is not allowed. The rejected entry name is written to the error log. Please remove it and upload again.',
    ...
    'system' => [
        ...
        'meili' => 'Meilisearch (full-text search) settings',
        'meili_host' => 'Meilisearch Host',
        'meili_key' => 'Master API Key',
        'meili_index' => 'Index name',
        'meili_global_search' => 'Enable Global Search via Meilisearch',
        'meili_realtime_sync' => 'Real-time index sync',
        'meili_batch_size' => 'Batch size (indexing)',
        'meili_repair_enabled' => 'Scheduled index repair',
        'meili_repair_at' => 'Repair time (HH:MM)',
        'meili_filter_mode' => 'Search filter columns',
        'meili_filter_mode_options' => [
            'override' => 'Auto + Custom',
            'manual' => 'Custom only',
        ],
        'meili_filter_alias' => 'Alias (merge key)',
        'meili_filter_type' => 'Filter type',
        'meili_filter_type_options' => [
            'equality' => 'Equality (status, category...)',
            'range' => 'Range (number, date...)',
        ],
        'meili_filter_include_mode' => 'Include/Exclude',
        'meili_filter_include_mode_options' => [
            'include' => 'Include (add this column)',
        ...
        'meili_filter_column_invalid' => 'The selected column cannot be used as a filter for this table. Select the table again, then choose a column.',
        'meili_dictionary' => 'Search dictionary (synonyms / stop words)',
        'meili_dictionary_type' => 'Type',
        'meili_dictionary_type_synonym' => 'Synonym',
        'meili_dictionary_type_stopword' => 'Stop word',
        'meili_dictionary_word' => 'Word',
        'meili_dictionary_synonyms' => 'Synonyms (comma / newline separated)',
        ...
        'help' =>[
            ...
            'meili_key' => 'Master API key of the Meilisearch server. Stored encrypted. Clearing this field saves an empty key, and the MEILISEARCH_KEY value in .env is used instead.',
            'meili_index' => 'Combined index name, e.g. exment_global. After changing it, run `php artisan exment:meili-index` to rebuild.',
            ...
            'meili_dictionary_type' => '"Synonym" = a group of terms treated as equivalent. "Stop word" = terms ignored during search (particles, etc.).',
            'meili_dictionary_word' => 'Synonym = the group main term. Stop word = the word(s) to ignore (comma/newline for multiple).',
            'meili_dictionary_synonyms' => 'Terms treated as equivalent to the main word, comma/newline separated (e.g. contract, agreement). Made mutually synonymous.',
            'meili_filter_alias' => 'Columns with the same meaning (e.g. status, contract_status) sharing one alias merge into a single filter group. Equality only; changing the alias triggers a reindex automatically on save.',
            'meili_filter_include_mode' => 'Include: add the column to the filter. Exclude: drop an auto column from the filter (only applies in "Auto + Custom" mode).',
    ...
    'search' => [
        ...
        'filter_unavailable' => 'The search engine could not apply the selected filters, so no results are shown. Clear the filters or try again later.',
        'sort_unavailable' => 'The search engine is unavailable, so the selected sort order is not applied.',
        'partial_results' => 'There are too many matches, so only part of the records you may view can be shown. Select yourself under "Created User" on the left, or add keywords or filters.',
        'reindex_skipped' => 'The setting was saved, but the search index was not updated: the table is large and the queue connection is "sync". Please run "php artisan exment:meili-index".',
        'sort_relevance' => 'Relevance',
        'sort_newest' => 'Newest first',
        'sort_oldest' => 'Oldest first',
        'filter_more' => '%s more…',
        'saved_name_invalid' => 'Please enter a name (max 100 characters).',
        'share_targets_invalid' => 'Choose who to share with (only role groups and organizations you belong to).',
        'share_all_denied' => 'Only system administrators can share with everyone.',
        'saved_limit_reached' => 'You can keep up to %d saved searches. Delete one you no longer need, then save again.',
        'range_min' => 'min',
        'range_max' => 'max',
        'result_unit' => 'results',
        ...
        'saved_prompt_name' => 'Enter a name for this search',
        'saved_dropped' => 'Some saved conditions are no longer valid and were skipped',
        'saved_with_keyword' => 'Also save the search keyword',
        'saved_share_scope' => 'Share scope',
        'share_personal' => 'Only me',
        'share_all' => 'All users',
        'share_role_group' => 'Role group',
        'share_organization' => 'Organization',
    ],
    ...
    'menu' => [
        ...
        'system_definitions' => [
            ...
            'meili_filter' => 'Search Filter Setting',
            'meili_dictionary' => 'Search Dictionary Setting',
            'plugin' => 'Plugin',
            'custom_table' => 'Custom Table',
            'role_group' => 'Role group',
            'menu' => 'Menu',
