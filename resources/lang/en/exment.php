...
return [
    ...
    'system' => [
        ...
        'system_line' => 'LINE Setting',
        'system_line_channel_token' => 'Channel access token',
        'system_line_channel_secret' => 'Channel secret',
        'system_line_oa_basic_id' => 'LINE Official Account Basic ID',
        'system_line_webhook_url' => 'Webhook URL',
        'safety_check' => 'Safety Check Settings',
        'safety_check_auto_enabled' => 'Auto-send on Earthquake',
        'safety_check_min_scale' => 'Minimum Seismic Intensity to Auto-send',
        'safety_check_cooldown_minutes' => 'Resend Interval (minutes)',
        'safety_check_comment_window_minutes' => 'Comment Window (minutes)',
        'safety_check_max_bulletin_age_minutes' => 'Bulletin Validity Window (minutes)',
        'safety_check_resend_throttle_minutes' => 'Resend Throttle (minutes)',
        'safety_check_index_limit' => 'Events Shown on Admin Page',
        ...
        'help' =>[
            ...
            'system_line_oa_basic_id' => 'The LINE Official Account Basic ID (starts with @). Used to build the account-link deep link.',
            'safety_check_auto_enabled' => 'If set to YES, a safety check notification will be sent automatically when an earthquake at or above the configured seismic intensity is detected.',
            'safety_check_min_scale' => 'Select the minimum seismic intensity (nationwide maximum) that triggers an automatic send.',
            'safety_check_cooldown_minutes' => 'Set the interval (in minutes) before another notification is auto-sent for the same earthquake.',
            'safety_check_comment_window_minutes' => 'How long (in minutes) text messages are accepted as comments after the user presses an answer button. Each comment extends the window.',
            'safety_check_max_bulletin_age_minutes' => 'Earthquake bulletins older than this (minutes) never auto-send, even if they meet the intensity threshold. Prevents notifications about past earthquakes right after enabling the feature.',
            'safety_check_resend_throttle_minutes' => 'The "resend" action on the safety-check admin page cannot run again within this many minutes of the previous resend. 0 disables the throttle.',
            'safety_check_index_limit' => 'Maximum number of events listed on the safety-check admin page.',
    ...
    'notify' => [
        ...
        'flex_template_id' => 'LINE Flex template',
        'line_show_detail' => 'View details',
        ...
        'help' => [
            ...
            'flex_template_id' => 'Flex message template for LINE. If selected, sends a card (otherwise plain text). Approve/Reject buttons are added automatically only when the target table has a workflow and the recipient has authority on a pending action.',
    ...
    'safety' => [
        ...
        'event_table_view_name'  => 'Safety Check Events',
        'answer_table_view_name' => 'Safety Check Answers',
        'col_title' => 'Title', 'col_trigger_type' => 'Trigger Type', 'col_event_status' => 'Status',
        'col_triggered_at' => 'Triggered At', 'col_jma_event_id' => 'JMA Event ID', 'col_quake_info' => 'Quake Info', 'col_quake_time' => 'Quake Occurred At',
        'col_target_count' => 'Target Count', 'col_sent_count' => 'Sent Count', 'col_resent_at' => 'Resent At',
        'col_event' => 'Event', 'col_user' => 'User', 'col_answer_status' => 'Answer Status',
        'col_comment' => 'Comment', 'col_answered_at' => 'Answered At', 'col_channel' => 'Answer Channel',
        'col_unlinked_flg' => 'LINE Not Linked',
        'flex_template_name' => 'Safety Check', 'flex_template_desc' => 'System template for sending safety check messages.',
        'mail_template_view_name' => 'Safety check mail',
        ...
        'quake_max_scale' => 'Max Shindo :scale',
        'status_safe' => 'Safe', 'status_minor_injury' => 'Minor Injury', 'status_need_help' => 'Need Help',
        'flex_note' => 'Please send any additional details as a message',
        'drill_prefix' => '[Drill] ',
        'answer_done' => 'Recorded ":status". If you have additional details, please send them as a message.',
        'answer_closed' => 'This safety check has been closed.',
        'comment_added' => 'Comment added.',
        'new_event_title' => 'Send New', 'col_answered_count' => 'Answered Count',
        'trigger_type_manual' => 'Manual', 'trigger_type_drill' => 'Drill', 'trigger_type_jma_auto' => 'JMA Auto',
        'event_status_open' => 'Open', 'event_status_closed' => 'Closed',
        'button_send' => 'Send', 'button_resend' => 'Resend', 'button_close' => 'Close',
        'confirm_resend' => 'Resend to unanswered users. Are you sure?',
        'confirm_close' => 'Close this safety check. Are you sure?',
        'message_send_succeeded' => 'Safety check sent.',
        'message_resend_succeeded' => 'Resent.',
        'message_resend_throttled' => 'Please wait at least :minutes minutes between re-sends.',
        ...
        'answer_comment_label' => 'Comment (optional)',
