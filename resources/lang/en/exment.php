...
return [
    ...
    'system' => [
        ...
        'safety_check_comment_window_minutes' => 'Additional Response Window (minutes)',
        'safety_check_max_bulletin_age_minutes' => 'Earthquake History Range (minutes)',
        'safety_check_resend_throttle_minutes' => 'Manual Resend Interval (minutes)',
        ...
        'help' =>[
            ...
            'safety_check_auto_enabled' => 'If set to YES, a notification is sent automatically when an earthquake at or above "Minimum Seismic Intensity to Auto-send" is detected.',
            'safety_check_min_scale' => 'A notification is sent automatically when an earthquake at or above the selected seismic intensity (nationwide maximum) is detected.',
            'safety_check_cooldown_minutes' => 'Interval before sending again for the same earthquake.<br/>Example: if bulletins for the same earthquake are received between 02:02 and 02:12, a 60-minute setting sends once at 02:02, while a 5-minute setting sends twice, at 02:02 and 02:12.<br/>For a different earthquake, the notification is sent regardless of this interval.',
            'safety_check_comment_window_minutes' => 'How long (in minutes) additional responses are accepted after the user presses a safety-check answer button.',
            'safety_check_max_bulletin_age_minutes' => 'Leave this at 10. Normally there is no need to change this setting.',
            'safety_check_resend_throttle_minutes' => 'Sets how long you must wait before sending a notification again. Resending is not possible within this period. 0 disables the limit.',
    ...
    'safety' => [
        ...
        'col_comment' => 'Additional Response', 'col_answered_at' => 'Answered At', 'col_channel' => 'Answer Channel',
        ...
        'comment_added' => 'Additional response added.',
