...
return [
    ...
    'custom_table' => [
        ...
        'inherit_parent_permission' => 'Inherit Parent Data Authority',
        ...
        'help' => [
            ...
            'inherit_parent_permission' => 'If set to YES, the data can be viewed based on the the parent data(1:N) permissions. However, you must have some access permissions to this table itself.',
