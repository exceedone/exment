...
return [
    ...
    'system' => [
        ...
        'chatbot_faq_wf' => 'FAQ Approval for Chatbot',
        'chatbot_faq_wf_status_filters' => 'FAQ Approval Status',
        ...
        'help' =>[
            ...
            'chatbot_faq_wf' => 'Set to YES to manage chatbot FAQ exchanges with an approval workflow. The chatbot uses ONLY approved exchanges stored in the FAQ table as future references when answering.',
            'chatbot_faq_wf_status_filters' => 'Enter the approval status name for chatbot FAQ display.',
