...
return [
    ...
    'common' => [
        ...
        'grid_column_visibility' => 'Select columns to show',
        'grid_column_search' => 'Search columns...',
        'grid_column_all' => 'Select all',
        'grid_column_none' => 'Clear all',
        'grid_column_default' => 'Reset to default',
        'grid_column_apply' => 'Apply',
        'grid_column_empty' => 'Please select at least one column.',
        'grid_density' => 'Density',
        'grid_density_compact' => 'Compact',
        'grid_density_comfortable' => 'Comfortable',
        'grid_density_spacious' => 'Spacious',
        'grid_nowrap' => 'Single line rows',
        'grid_auto_refresh' => 'Auto refresh',
        'grid_auto_refresh_off' => 'Off',
        'grid_auto_refresh_30' => '30 seconds',
        'grid_auto_refresh_60' => '1 minute',
        'grid_auto_refresh_300' => '5 minutes',
        'grid_pin' => 'Pin columns',
        'grid_pin_preset_2' => 'Pin first 2 columns',
        'grid_pin_preset_3' => 'Pin first 3 columns',
        'grid_pin_none' => 'Unpin all',
        'grid_pin_actions' => 'Pin action column to the right',
        'grid_pin_head' => 'Pin header row',
        'grid_pin_flag' => 'Pinned',
        'grid_pin_narrow' => 'Some columns were left unpinned because the screen is too narrow.',
        'grid_group' => 'Group rows',
        'grid_group_page' => 'this page only',
        'grid_group_none' => 'No grouping',
        'grid_bulk_selected' => '{n} selected',
        'grid_bulk_clear' => 'Clear selection',
        'grid_bulk_edit' => 'Bulk edit',
        'grid_bulk_export' => 'Bulk export',
        'grid_bulk_edit_title' => 'Bulk edit',
        'grid_bulk_edit_pick_column' => 'Choose the column to update',
        'grid_bulk_edit_pick_fields' => 'Fill only the fields you want to change (blank = keep current)',
        'grid_bulk_edit_no_change' => '(no change)',
        'grid_bulk_edit_nothing' => 'No field selected to change',
        'grid_bulk_edit_column' => 'Column',
        'grid_bulk_edit_value' => 'Value',
        'grid_bulk_edit_apply' => 'Apply to {n} rows',
        'grid_bulk_edit_cancel' => 'Cancel',
        'grid_bulk_edit_confirm' => 'Update {n} records?',
        'grid_bulk_edit_progress' => 'Updating {done}/{total}...',
        'grid_bulk_edit_summary_ok' => 'Updated {n} records',
        'grid_bulk_edit_summary_partial' => '{ok} succeeded, {fail} failed',
        'grid_bulk_export_format' => 'Export format',
        'grid_bulk_export_csv' => 'CSV',
        'grid_bulk_export_xlsx' => 'Excel',
        'grid_inline_edit' => 'Edit',
        'grid_inline_saving' => 'Saving...',
        'grid_inline_saved' => 'Saved',
        'grid_inline_error' => 'Save failed',
        'grid_ctx_view' => 'View',
        'grid_ctx_preview' => 'Quick preview',
        'grid_ctx_assign' => 'Set me as :column',
        'grid_ctx_assign_done' => ':column changed to you.',
        'grid_ctx_assign_error' => 'Could not change it. Please check your permission and the input rules.',
        'grid_peek_loading' => 'Loading...',
        'grid_peek_error' => 'Could not load the preview.',
        'grid_peek_open' => 'Open full page',
        'grid_peek_close' => 'Close',
        'grid_ctx_edit' => 'Edit',
        'grid_ctx_copy' => 'Duplicate as new',
        'grid_ctx_filter' => 'Filter within this page',
        'grid_ctx_copy_cell' => 'Copy cell value',
        'grid_ctx_delete' => 'Delete',
        'grid_ctx_delete_confirm' => 'Delete this record?',
        'grid_filter_chip_title' => 'Filtered by',
        'grid_filter_chip_remove' => 'Remove this condition',
        'grid_filter_chip_clear' => 'Clear all',
        'grid_filter_chip_null' => 'Not set',
        'grid_filter_active' => 'Filtering this page: {v}',
        'grid_filter_hidden' => '{n} hidden',
        'grid_filter_clear' => 'Clear filter',
        'system' => 'System',
    ...
    'plugin' => [
        ...
        'error' => [
            ...
            'migration_error' => 'The plugin was registered, but running its bundled migrations failed. Please check the log or contact your system administrator.',
    ...
    'workflow' => [
        ...
        'designer' => [
            'title' => 'Flow Preview',
            'hint' => 'Click a shape to select its row on the left',
            'no_issue' => 'No problem',
            'issue_count' => ':count item(s) to check',
            'issue_pop_title' => ':count item(s) to check (click to jump)',
            'issue_none' => 'No problem found.',
            ...
            'legend_completed' => 'Completed status',
            'legend_action' => 'Action (transition)',
            'legend_ignore' => 'Special action (reject etc.)',
            'legend_branch' => '= branch of condition n',
            'legend_cond' => '= has filter condition',
            'chip_completed' => 'Done',
            'chip_datalock' => 'Locked',
            'deleted_status' => '(deleted)',
            'noname_action' => '(no name)',
            'branch' => 'Condition :no',
            'cond_count' => ':count filter condition(s)',
            'cond_and' => 'Match all conditions',
            'cond_or' => 'Match any condition',
            'cond_reverse' => 'Reverse condition',
            'issue_no_view_name' => 'The workflow name is empty. It cannot be saved as is.',
            'issue_no_start_name' => 'The start status name is empty. It cannot be saved as is.',
            'issue_no_start' => 'No action starts from ":status". Please connect it to the first status.',
            'issue_unreachable' => 'No action reaches ":status".',
            'issue_deadend' => '":status" has no outgoing action and is not a completed status.',
            'issue_no_status_from' => 'Status before execution is not set on action ":action".',
            'issue_no_status_to' => 'Status after execution is not set on action ":action".',
            'issue_unknown_status' => 'Action ":action" refers to a deleted status.',
            'issue_no_name' => 'There is a row with no action name. It cannot be saved as is.',
            'issue_long_name' => 'The action name of ":action" is longer than 30 characters.',
            'issue_same_action' => 'Action ":action" has the same status before and after execution. It cannot be saved as is.',
            'issue_no_target' => 'Executable user is not set on action ":action". It cannot be saved as is.',
            'issue_ignore_action_select' => 'Action ":action": "Special Action" cannot be set when the executable user is "Select the user who executed the previous action".',
            'issue_target_mix' => 'Action ":action": in the same pre-execution status ":status", "Select the user who executed the previous action" cannot be combined with other settings.',
            'save_pos' => 'Save layout',
            'save_pos_on' => 'Node layout is saved: save this screen and the current layout is kept, so it looks the same next time.',
            'save_pos_off' => 'Node layout is not saved. Click to start saving it.',
            'save_pos_dirty' => ' (unsaved changes)',
            'leave_confirm' => 'The flow preview layout has changes that are not saved yet. Leave this page without saving?',
            'issue_flow_next_count' => 'The number of people in "Condition to advance to next status" on action ":action" must be a number from 0 to 10. It cannot be saved as is.',
            'tip_flow_some' => 'Advances when :count or more execute',
            'tip_flow_all' => 'Advances when all execute',
            'tip_ignore' => 'Special action (excluded from work users)',
        ],

        'design' => [
            'header' => 'Flow designer',
            'description' => 'Create and edit statuses and actions directly on the flow chart. It saves to the same place as step 1 and step 2.',
            'to_list' => 'Back to list',
            'to_step1' => 'Step 1 (status setting)',
            'to_step2' => 'Step 2 (action setting)',
            'to_step3' => 'Step 3 (notify setting)',
            'to_step4' => 'Step 4 (usage setting)',
            'step3_wait' => 'After completing the setting, you can set up notifications.',
            'activate_hint' => 'Statuses and actions are ready. You can complete the setting.',
            'activate_wait' => 'Create statuses and actions and save, then you can complete the setting.',
            'step4_wait' => 'After completing the setting, you can choose the workflow for each table.',
            'step_new' => 'Available after you save.',
            'new_workflow' => 'Create with designer',
            'new_description' => 'Create a new workflow while drawing the flow. After you save, the workflow is registered and you can go to step 3 (complete setting).',
            'new_note' => 'The workflow is not registered until you save. Set the name and type first, then create statuses and actions.',
            'basic_info' => 'Basic information',
            'issue_no_type' => 'Please select the workflow type.',
            'issue_no_table' => 'Please select the target table.',
            'saving' => 'Saving...',
            'reset_layout' => 'Reset layout',
            'reset_layout_confirm' => 'Put the nodes back to the automatic layout. No status or action is removed.',
            'hint_title' => 'How to use',
            'hint_add' => 'Right click on an empty area to add a status',
            'hint_connect' => 'Drag the dot on the right edge of a status and drop it on another status to create an action',
            'hint_action' => 'Right click an action name to open its setting',
            'hint_close' => 'Close',
            'status_add' => 'Add status',
            'status_edit' => 'Status setting',
            'status_delete' => 'Delete status',
            'status_menu' => 'Status: :name',
            'start_menu' => 'Start: :name',
            'start_edit' => 'Rename start status',
            'action_menu' => 'Action: :name',
            'action_edit' => 'Action setting',
            'action_delete' => 'Delete action',
            'completed_flg' => 'Completed status',
            'help_completed_flg' => 'The status that means the flow has finished. You can set more than one (for example "Approved" and "Rejected"). Note that saving on step 1 keeps only the last row as completed.',
            'connect_new' => 'Create a new status and connect',
            'connect_title' => 'Create action (:from -> :to)',
            'create' => 'Create',
            'create_and_connect' => 'Create and connect',
            'create_and_setting' => 'Create and open setting',
            'branch' => 'Branch :no',
            'branch_add' => 'Add branch',
            'branch_remove' => 'Remove this branch',
            'branch_note' => 'Filter conditions are set on step 2 ":label". They are kept when you save here.',
            'branch_enabled' => 'Use this branch',
            'no_status' => 'No status yet. Right click the canvas to add one.',
            'delete_status_confirm' => 'Delete ":name". :count action(s) connected to it will be deleted too.',
            'delete_action_confirm' => 'Delete action ":name".',
            'unsaved' => 'Unsaved',
            'unsaved_leave' => 'You have unsaved changes. Leave this page?',
            'activated_note' => 'This workflow setting is already completed. You can still add or rearrange statuses and edit actions, but a status that already holds data cannot be deleted.',
            'status_in_use' => 'In use, cannot be deleted',
            'multi_completed_note' => 'This workflow has more than one completed status. They are kept here, but saving on step 1 would leave only the last one as completed.',
            'search_placeholder' => 'Search...',
            'add' => 'Add',
            'none' => 'Not set',
            'message' => [
                'conflict' => 'This workflow was updated somewhere else. Please reload the page and save again.',
                'validation_error' => 'Please check the input.',
                'completed_least' => 'Please set at least one completed status.',
                'unknown_status' => 'Action :action refers to a status that does not exist.',
                'status_in_use' => 'Status ":name" is used by existing data or history, so it cannot be deleted.'
            ],
        ],
    ...
    'custom_column' => [
        ...
        'options' => [
            ...
            'grid_style_header' => 'Cell appearance',
            'grid_preset' => 'Appearance preset',
            'grid_style' => 'Cell display style',
            'grid_color' => 'Text color',
            'grid_bg_color' => 'Background color',
            'grid_border_color' => 'Border color',
            'grid_font_weight' => 'Font weight',
            'grid_icon' => 'Icon',
            'grid_nowrap' => 'Do not wrap lines',
            'grid_value_colors' => 'Color per value',
        ...
        'grid_style_options' => [
            ...
            "tag" => "Tag (small radius)",
            "pill" => "Pill (large radius)",
            "badge" => "Badge (solid fill)",
            "dot" => "Square mark + text",
            "lvl" => "Round mark + text",
            "mono" => "Monospace",
            "avatar" => "Avatar (initial in a circle)",
            "bar" => "Progress bar (0-100)",
            "cell" => "Fill the whole cell",
        ],
        'grid_font_weight_options' => [
            "normal" => "Normal",
            "semibold" => "Semibold",
            "bold" => "Bold",
        ],
        ...
        'help' => [
            ...
            'grid_preset' => 'How this column is painted in the data list, picked from the preset library.<br/>To change a look, do not adjust this one column - create a new preset from the pencil button, so every other column can pick the same look.',
            'grid_style' => 'Choose how this column paints its values in the data list. "Default" keeps the display exactly as before.',
            'grid_color' => 'Text color of the value. On a select column with no "Color per value" set, a color is assigned automatically following the order of the options.',
            'grid_bg_color' => 'Background of a tag, a pill or a filled cell. Derived from the text color when left empty.',
            'grid_border_color' => 'Border of a tag, a pill or a filled cell. Derived from the text color when left empty.',
            'grid_font_weight' => 'Font weight of the value.',
            'grid_icon' => 'Icon drawn in front of the value, chosen from the button beside the field.<br/>The avatar, the progress bar and the painted cell draw no icon.',
            'grid_nowrap' => 'When set to YES, the text in the cell is never wrapped onto a second line.',
            'grid_value_colors' => 'Pick the color each choice is shown with in the list. A value left without a color gets one automatically, by the order of the choices.<br/>On a progress bar the rows are thresholds: the color applies from that value up.',
    ...
    'cell_style_preset' => [
        'header' => 'Cell style presets',
        'description' => 'Manages how data list cells look (the preset library). The column and view setting screens pick from the presets listed here.',
        'key' => 'Key',
        'column_types_all' => 'All column types',
        'icon_pick' => 'Choose an icon',
        'icon_clear' => 'Remove the icon',
        'order_help' => 'Position in the pickers on the setting screens. Smaller comes first.',
        'modal_title' => 'Edit appearance preset',
        'preset_name' => 'Preset name',
        'column_types' => 'Column types',
        'column_types_hint' => 'The preset is offered on the checked column types. Check none to offer it on every type.',
        'preview' => 'Preview',
        'preview_note' => 'How the data list will paint this column. It follows what you type; nothing has to be saved first.',
        'save_as_new' => 'Save as new preset',
        'save_update' => 'Update this preset',
        'delete_confirm' => 'Press again to delete',
        'readonly_note' => 'This preset cannot be edited. To use it with changes, save it as a new preset.',
        'copy_of' => 'Copy of %s',
        'color_placeholder' => 'Not specified',
        'clear_color' => 'Clear color',
        'not_specified' => 'Not specified',
        'edit_preset' => 'Create or edit a preset',
        'select_placeholder' => 'Select a preset',
        'error' => [
            'name_required' => 'Enter a preset name.',
        ],
        'builtins' => [
            'status_pill' => 'Status (pill)',
            'status_badge' => 'Status (badge)',
            'label_tag' => 'Label (tag)',
            'select_dot' => 'Choices (dot)',
            'priority_dot' => 'Priority (square dot)',
            'level_round' => 'Level (round dot)',
            'flag_badge' => 'YES/NO (badge)',
            'user_avatar' => 'Assignee (avatar)',
            'progress_bar' => 'Progress (bar)',
            'number_strong' => 'Number (bold)',
            'date_nowrap' => 'Date (no wrap)',
            'code_mono' => 'Code (monospace)',
            'text_plain' => 'Plain text (no name)',
            'alert_text' => 'Alert (red, bold)',
            'fill_cell' => 'Fill the whole cell',
        ],
    ],
    'custom_view' => [
        ...
        'grid_preset' => 'Cell appearance preset',
        ...
        // a column this setting already uses that the list can no longer
        // offer, its search setting having been turned off since
        'column_target_unavailable' => '(not selectable here) %s',
        ...
        'kanban_group_column' => 'Column for kanban lanes',
        'kanban_swimlane_column' => 'Column for swimlanes',
        'kanban_editable' => 'Allow changing values by drag and drop',
        'kanban_max_count' => 'Max display count',
        'kanban_card_columns' => 'Columns displayed on the card',
        'kanban_empty_label' => 'Not set',
        'kanban_search_placeholder' => 'Search in cards',
        'gantt_start_column' => 'Start date column',
        'gantt_end_column' => 'End (due) date column',
        'gantt_color_column' => 'Bar color (select column)',
        'gantt_progress_column' => 'Progress column (0-100)',
        'gantt_group_column' => 'Group rows by',
        'gantt_parent_column' => 'Parent column (self reference)',
        'gantt_assignee_column' => 'Assignee column',
        'gantt_max_count' => 'Max records',
        'gantt_advanced_setting' => 'Advanced setting',
        'gantt_today' => 'Today',
        'gantt_due' => 'Due',
        'gantt_progress' => 'Progress',
        'gantt_no_bar' => 'No dates',
        'gantt_no_group' => 'No group',
        'gantt_empty' => 'There is no data to show.',
        'kanban_source' => 'How the board columns are made',
        'kanban_source_options' => [
            'column' => 'From the values of a select column',
            'workflow' => 'From the statuses of the workflow',
        ],
        'kanban_card_setting' => 'Card setting',
        'kanban_advanced_setting' => 'Advanced setting (optional)',
        'kanban_column_setting' => 'Board columns',
        'kanban_board_setting' => 'Board features',
        'kanban_load_setting' => 'How much to load',
        'kanban_wips' => 'WIP limit per column',
        'kanban_wip_key' => 'Target column',
        // a setting the list can no longer offer, the choice behind it is gone
        'kanban_value_missing' => '(unused setting) %s',
        'kanban_wip_column' => 'Count the WIP limit in (number column)',
        'kanban_sum_column' => 'Column totalled on the lane header',
        'kanban_col_age' => 'Show the average days spent in each lane',
        'kanban_hide_keys' => 'Board columns to leave out',
        'kanban_col_count' => 'Cards loaded per column',
        'kanban_history' => 'Show the approval history in the detail panel',
        'kanban_history_none' => 'No history yet',
        'kanban_progress_column' => 'Number column drawn as a progress bar',
        'kanban_progress_max' => 'Value that fills the progress bar',
        'kanban_limit_warn' => 'Warn this many hours before the deadline',
        'kanban_age_steps' => 'Age colour steps (yellow, orange, red)',
        'kanban_wip_limit' => 'Limit',
        'kanban_wip_enforce' => 'Moving into a full column',
        'kanban_wip_enforce_options' => [
            'off' => 'Allow it (red header only)',
            'warn' => 'Ask first',
            'block' => 'Do not allow it',
        ],
        'kanban_policies' => 'Column policy',
        'kanban_policy_key' => 'Column',
        'kanban_policy_text' => 'Policy',
        'kanban_policy_title' => 'Policy of this column',
        'kanban_wf_action' => 'Workflow actions',
        'kanban_done_keys' => 'Values treated as done',
        'kanban_blocked_keys' => 'Values treated as blocked',
        'kanban_expedite_keys' => 'Values treated as expedite',
        'kanban_blocked' => 'Blocked',
        'kanban_expedite' => 'Expedite',
        'kanban_blocked_partial' => 'Counted over the cards already loaded - there are at least this many.',
        'kanban_title_column' => 'Column used as the card title',
        'kanban_assignee_column' => 'Column for the assignee',
        'kanban_mine_column' => 'Column the "Mine" button reads',
        'kanban_filter_columns' => 'Columns shown in the filter panel',
        'kanban_limit_column' => 'Column for the deadline (SLA timer)',
        'kanban_age_column' => 'Column the elapsed days are counted from',
        'kanban_ai_column' => 'Column used by auto assign',
        'kanban_cover_column' => 'Column for the cover image',
        'kanban_cover_fit' => 'Cover image display',
        'kanban_labels_column' => 'Column for the colored labels',
        'kanban_labels_style' => 'Label display',
        'kanban_badge_column' => 'Column for the corner badge',
        'kanban_position' => 'Position',
        'kanban_style' => 'Style',
        'kanban_icon' => 'Icon',
        'kanban_kpi' => 'Show the summary bar (KPI)',
        'kanban_quickadd' => 'Show quick add',
        'kanban_bulk' => 'Allow multi select and bulk change',
        'kanban_editform' => 'Open the edit form when a card is clicked',
        'kanban_drawer' => 'Open a detail panel when a card is clicked',
        'kanban_filter' => 'Filter',
        'kanban_keyword' => 'Keyword',
        'kanban_all' => 'All',
        'kanban_none' => 'None',
        'kanban_groupby' => 'Group by',
        'kanban_only_over' => 'Overdue only',
        'kanban_only_unassigned' => 'Unassigned only',
        'kanban_only_mine' => 'Assigned to me only',
        'kanban_only_blocked' => 'Blocked only',
        'kanban_only_expedite' => 'Expedite only',
        'kanban_mine_button' => 'My cards',
        'kanban_inline_edit' => 'Change %s',
        'kanban_inline_clear' => 'Clear',
        'kanban_save_view' => 'Save this as a view',
        'kanban_save_view_name' => 'View name',
        'kanban_view_open' => 'Open',
        'kanban_collapse' => 'Collapse column',
        'kanban_expand' => 'Expand column',
        'kanban_reset' => 'Reset',
        'kanban_no_card' => '- none -',
        'kanban_quickadd_placeholder' => '+ Quick add (Enter)',
        'kanban_unassigned' => 'Unassigned',
        'kanban_drag_hint' => 'Drag to move',
        'kanban_open_record' => 'Open record',
        'kanban_detail' => 'Open detail panel',
        'kanban_undo' => 'Undo',
        'kanban_day' => 'd',
        'kanban_col_age_title' => 'Average days in lane',
        'kanban_col_total' => 'of %s',
        'kanban_col_wip' => 'WIP limit: %s / %s (total of this column)',
        'kanban_col_wip_all' => "WIP limit: %s / %s (total of every lane)\nThe limit is measured over the whole column, so it does not match the count of this lane.",
        'kanban_search_more' => 'Loaded %s more matching cards.',
        'kanban_more' => 'Load more (%s left)',
        'kanban_more_plain' => 'Load more',
        'kanban_move_to' => 'Move to',
        'kanban_selected' => 'selected',
        'kanban_bulk_move' => 'Bulk change...',
        'kanban_bulk_assign' => 'Bulk assign...',
        'kanban_sel_clear' => 'Clear selection',
        'kanban_kpi_open' => 'Open',
        'kanban_kpi_unassigned' => 'Unassigned',
        'kanban_kpi_breach' => 'Overdue',
        'kanban_kpi_age' => 'Avg. elapsed days',
        'kanban_kpi_done' => 'Done',
        'kanban_kpi_blocked' => 'Blocked',
        'kanban_sla_done' => 'Met',
        'kanban_sla_over' => 'Overdue %s',
        'kanban_sla_soon' => 'Due soon, %s left',
        'kanban_sla_left' => '%s left',
        'kanban_ai_button' => 'Auto assign',
        'kanban_ai_recommend' => 'Recommended assignee',
        'kanban_ai_apply' => 'Apply this assignee',
        'kanban_ai_auto' => 'Assigned automatically (confidence 85% or more)',
        'kanban_ai_suggest' => 'Suggestion only (please confirm manually)',
        'kanban_ai_result' => '%s assigned automatically (confidence 85 percent or more) / %s suggestions only',
        'kanban_position_options' => [
            'header' => 'Card header',
            'meta' => 'Body line 1',
            'meta2' => 'Body line 2',
            'foot' => 'Card footer',
        ],
        'kanban_cover_fit_options' => [
            'cover' => 'Fill (overflow is cropped)',
            'contain' => 'Fit whole image (letterboxed)',
        ],
        'kanban_labels_style_options' => [
            'chip' => 'Chip with text',
            'bar' => 'Color bar only',
        ],
        'description_custom_view_columns' => 'Select display columns.',
        'description_custom_view_kanban_columns' => 'Select the columns displayed on the card. "Position" decides where in the card they appear, "Style" picks a cell appearance preset (tag, pill, badge and so on) - the same library the data list uses, so one look is defined once and worn on both screens.<br/>*Left empty, the card follows the column setting, and falls back to "name and value" when there is none.<br/>*"Icon" takes a Font Awesome class name (for example fa-phone). Comma separated "value:class" pairs give each value its own icon.<br/>*If not set, the card shows the title only.',
        ...
        'help' => [
            ...
            'grid_preset' => 'Paints this column with the chosen preset in the data list.<br/>It wins over the column setting.<br/>Use the pencil button to create or edit a preset.',
            ...
            'kanban_group_column' => 'The options of this column become the kanban lanes.<br/>*Only single-value select columns can be chosen.',
            'kanban_swimlane_column' => 'Split the board horizontally by the value of this column.<br/>*If not set, the board is shown without splitting.',
            'kanban_editable' => 'If YES, dragging a card to another lane updates the value of "Column for kanban lanes".<br/>*Users without edit permission cannot drag even if YES.',
            'kanban_max_count' => 'Max number of records drawn on the board. A large number slows the page down.',
            'gantt_start_column' => 'The date column a bar starts from.',
            'gantt_end_column' => 'The date column a bar ends on.<br/>*A record past this date with progress under 100 is shown with a red overdue ring.',
            'gantt_color_column' => 'Bars are colored by the values of this column.<br/>*The colors set on the column value-color setting are used as they are.',
            'gantt_progress_column' => 'The progress (%) is drawn as a darker overlay inside the bar.',
            'gantt_group_column' => 'Rows are grouped by the values of this column.<br/>*For a select_table column (a milestone table...), the first date column of the target table is shown as the deadline diamond.',
            'gantt_parent_column' => 'Pick a column that references this table itself, and children are indented under their parent.',
            'gantt_assignee_column' => 'Pick a user column to show an avatar on each row.',
            'gantt_max_count' => 'Max records drawn on the chart (10-2000, default 500).',
            'kanban_source' => 'Where the kanban lanes come from.<br/>*From a select column: its options become the lanes.<br/>*From the workflow: the statuses of the workflow applied to this table become the lanes. Dragging a card opens the workflow action that leads to that status, so a move the workflow does not allow is refused.',
            'kanban_wip_enforce' => 'What happens when a card is dropped on a column that is already at its WIP limit.<br/>"Allow it" keeps the old behaviour: the header turns red and the card still moves.<br/>"Ask first" shows a confirmation and moves the card only if you agree.<br/>"Do not allow it" greys the full column out while dragging and refuses the drop.<br/>*Columns with no WIP limit are never affected.<br/>*Cards matching "Values treated as expedite" are exempt from this rule, but still counted - so the column stays visibly over its limit.',
            'kanban_policies' => 'A rule shown on the column header - hover the marker to read it.<br/>Example: on the "Testing" column write "every item of the test sheet signed off before it moves on", and the exit condition is visible to the whole team.<br/>*The target column is picked from the values of the table (or the statuses of the workflow).<br/>*A setting that does not match the columns now shown is ignored.',
            'kanban_wips' => 'Max number of cards a lane may hold. The target lane is picked from the values of the table (or the statuses of the workflow), never typed by hand.<br/>*A lane over its limit gets a red header.<br/>*A setting that does not match the lanes now shown is ignored.',
            'kanban_done_keys' => 'Lanes that mean "finished", picked from the values of the table.<br/>*Those records stop the deadline countdown and are counted as "Done" in the summary bar.<br/>*On a workflow board every status flagged as completed is already treated as done, so nothing has to be set here.<br/>*A setting that does not match the lanes now shown is ignored.',
            'kanban_title_column' => 'Column shown as the bold title inside the card.<br/>*When set, the record label is shown as a link at the top of the card.<br/>*When not set, the record label itself becomes the title.',
            'kanban_assignee_column' => 'Column holding the assignee.<br/>*Shown with an avatar at the bottom of the card; empty cards show "Unassigned".<br/>*Also used by the summary bar, the "Unassigned only" filter and bulk assign.<br/>*<b>Left empty</b>, the board has no avatar, no "Unassigned" tile, no "Unassigned only" filter, no bulk assign, no assignee editing on the card and no auto-assign. The "Mine" button is gone too, unless a column is named under "Column deciding what counts as mine".',
            'kanban_mine_column' => 'Which column the "Mine" button on the toolbar reads to decide that a card is yours.<br/>*If not set, the assignee column is used. Point it at the requester column to narrow the board down to the work you raised.<br/>*User and organization columns can be used, and so can a column pointing at a table that holds exactly one user column (the rows tied to you are found through it).<br/>*If the column cannot tell who is looking (a plain select, for example), the button is not shown.',
            'kanban_filter_columns' => 'Pick only the columns the filter panel should offer. They are shown in the order you pick them.<br/>*If not set, every column the board reads is offered (groupable columns, the assignee, the card fields and so on), which is a long list on a wide table.<br/>*The keyword box, grouping, swimlane and the checkboxes are always shown, whatever this setting says.',
            'kanban_limit_column' => 'The deadline date column.<br/>*From the difference with now, the card shows a "left", "due soon" or "overdue" badge.<br/>*A record whose lane is treated as done shows "met" instead.<br/>*<b>Left empty</b>, the board has no deadline badge, no "Overdue" tile, no "Overdue only" filter and no deadline editing on the card.',
            'kanban_sum_column' => 'Show the total of this number column under the lane header.<br/>Example: pick an amount and the header reads "Director approval &yen;34,700,000", so the money stuck in a lane is visible at a glance.<br/>*Display only - it does not affect the WIP limit.<br/>*Digits and currency mark follow that column own setting.<br/>*Filtering the board totals only the cards left on screen.',
            'kanban_blocked_keys' => 'Values that mean work has stopped. Their cards get a red edge and a flag, and "Blocked" is added to the KPI row and to the filter panel.<br/>Example: "On hold" and "Sent back" of a status column, or "Yes" of a dedicated blocked column.<br/>*It does not have to be the column the board groups by - any value of any column can be picked.<br/>*This is what separates work in flight from work that has stalled.',
            'kanban_expedite_keys' => 'Values that mean an urgent interruption. Their cards get a strong outline, and when the board is split by that same column the lane is pinned to the top.<br/>Example: "Urgent" of a priority column.<br/>*Expedite cards are never refused by "Moving into a full column", matching the usual kanban policy that an interruption may exceed the limit. They are still counted, so the cost of the interruption stays on screen.<br/>*Marking many values as expedite makes the mark meaningless - keep it to one or two.',
            'kanban_hide_keys' => 'Board columns for the chosen values are not drawn.<br/>Example: leave out "Done" and "Cancelled" and the board holds only the work still moving.<br/>*Their records are never read, so on a large table this alone makes the board much faster.<br/>*They are left out of the totals, the averages and the KPI row as well.<br/>*On a workflow board, moving a record into a hidden status makes its card disappear from the board (the record itself is untouched).<br/>*The "not set" column cannot be hidden.<br/>*A setting that does not match the lanes now shown is ignored.',
            'kanban_col_count' => 'How many cards each column loads to begin with.<br/>0 (empty) keeps the old behaviour: one query for the whole board, up to the maximum record count.<br/>Set 50 and every column loads 50 cards with a "load more" button underneath.<br/>*Counts, totals, average days and the KPI row are then measured over the whole table, not over the cards that happen to be loaded.<br/>*Recommended once a table holds thousands of records - the maximum record count no longer caps the board.<br/>*The swimlane set on the view keeps them: each cell (column x lane) then shows its own count, measured over the whole table.<br/>*A filter, a keyword search, another grouping, or a swimlane picked on screen rather than on the view, fall back to the cards already loaded.',
            'kanban_col_age' => 'Show, under the lane header, how many days on average the cards of that lane have been sitting there.<br/>*It points at the step where work piles up.<br/>*Counted from the moment the record reached its status on a workflow board, from its last edit otherwise.',
            'kanban_progress_column' => 'Number column drawn as a progress bar under the card title.<br/>*0-49% blue, 50-99% orange, 100% green.<br/>*Cards with an empty value get no bar.',
            'kanban_progress_max' => 'The value the progress bar counts as 100%.<br/>Example: 100 for a percentage, 10 for a ten step process.<br/>*Defaults to 100.',
            'kanban_history' => 'Show the workflow history - when, who and which action - in the card detail panel.<br/>*Loaded for the opened card only, so the board itself stays as fast as before.<br/>*Only shown on tables that use a workflow.',
            'kanban_wip_column' => 'Count the WIP limit as the sum of this number column instead of the number of cards.<br/>Example: pick a quantity and the lane header shows "1550/1200".<br/>*Leave empty to keep counting cards.<br/>*Only integer, decimal and currency columns can be chosen.',
            'kanban_limit_warn' => 'A card closer to its deadline than this many hours turns yellow.<br/>Example: 2 for a support ticket, 48 (=2 days) for a delivery date.<br/>*Empty means 2 hours.',
            'kanban_age_steps' => 'Three ascending numbers of days, separated by commas, that turn the card border yellow, orange and red.<br/>Example: 1,2,3 for a ticket, 3,7,14 for a long process.<br/>*Anything that is not three ascending numbers is treated as 1,2,3.',
            'kanban_age_column' => 'Date column the elapsed days are counted from (for example the opened date).<br/>*The left edge of the card is colored by age (1 day yellow, 2 days orange, 3 days or more red).<br/>*Also used by the "Avg. elapsed days" summary.',
            'kanban_ai_column' => 'Column used to pick a recommended assignee (for example the assignment group).<br/>*The person who handles that value most often is recommended for unassigned cards.<br/>*The "Auto assign" button only appears when this and "Column for the assignee" are both set.',
            'kanban_cover_column' => 'Image column shown as a cover at the top of the card.<br/>*Records without an image show no cover.<br/>*When several images are stored, the first one is used.<br/>*The image itself is uploaded to this column on the data edit form.',
            'kanban_cover_fit' => 'How the cover image sits in its box.<br/>*"Fill" covers the whole box and crops the overflow.<br/>*"Fit whole image" shows the complete image with side padding.',
            'kanban_labels_column' => 'Select column shown as colored labels at the top of the card.<br/>*A multi-value column works too: every value gets its own label.<br/>*The column is also added to the filter panel, matching cards that carry any of the labels.',
            'kanban_labels_style' => 'How the labels look.<br/>*"Chip" is a small label with text, "Color bar" is a thin colored strip (Trello style).',
            'kanban_badge_column' => 'Column shown as a small badge in the top right corner of the card (a count, points, a number...).<br/>*Records with an empty value show no badge.',
            'kanban_kpi' => 'If YES, a summary bar of counts is shown above the board.',
            'kanban_quickadd' => 'If YES, each lane gets an input box that creates a record with the Enter key.<br/>*Only the label column and that lane value are filled in.',
            'kanban_bulk' => 'If YES, Shift+click selects several cards so they can be changed together.',
            'kanban_editform' => 'If YES, clicking a card opens the edit form of that record over the board. Saving closes the form and redraws that one card.<br/>*Not shown to anyone without edit rights.<br/>*If NO, the "detail panel" setting below decides what a click does.',
            'kanban_drawer' => 'If YES, clicking a card opens a detail panel on the right.<br/>*If NO, it opens the record page instead.<br/>*While "open the edit form" above is also YES, the click opens the form and the panel opens from the "i" button at the top right of the card.',
            'kanban_position' => 'Where inside the card this column is shown.',
            'kanban_style' => 'Paints this column on the card with the chosen preset.<br/>It wins over the column setting.<br/>Use the pencil button to create or edit a preset.<br/>Left empty the card follows the column setting, and falls back to "name and value" when there is none.',
            'kanban_icon' => 'A Font Awesome class name, for example fa-phone.<br/>To give each option its own icon, enter "value:class" pairs separated by commas.<br/>Example: phone:fa-phone,mail:fa-envelope,chat:fa-comments',
        ],
        ...
        'custom_view_menulist' => [
            ...
            'create_kanban' => 'Kanban view new creation',
            'create_gantt' => 'Gantt chart view new creation',
            ...
            'help' => [
                ...
                'create_kanban' => 'Create a new kanban view that shows records as cards grouped by a select column, and lets you change the value by drag and drop.',
                'create_gantt' => 'Create a new gantt chart view that draws each record as a bar from its start date to its due date.',
        ...
        'message' => [
            ...
            'preview_not_supported' => 'This view kind has no preview. It is available for the data list, the kanban board and the gantt chart.',
            'preview_skipped' => ':count row(s) are left out of this preview: their column or condition is not chosen yet.',
            'filter_ignored' => 'A display filter with no condition set was ignored. Open the view setting screen and choose the condition again.',
            'kanban_no_group_column' => 'The column for kanban lanes is not set. Open the view setting and select "Column for kanban lanes".',
            'kanban_group_column_required' => 'Please select "Column for kanban lanes". A board made from a select column cannot be drawn without it.',
            'kanban_age_steps_format' => 'Please input "Aging color steps" like "1,2,3" (3 comma-separated numbers, ascending).',
            'gantt_no_date_setting' => 'The gantt chart needs both the start date column and the end date column. Pick them on the view setting screen.',
            'gantt_over_limit' => 'The number of records exceeds the limit (%s). Please narrow it down with the display filter.',
            'kanban_no_workflow' => 'No active workflow is applied to this table. Set up a workflow, or change "How the board columns are made" back to "From the values of a select column".',
            'kanban_wf_no_action' => '%s cannot move to "%s". The workflow does not allow this move, or you may not run it.',
            'kanban_wf_locked' => 'This record is locked by the workflow.',
            'kanban_wf_none' => 'There is no workflow action you can run on this record right now.',
            'kanban_over_limit' => 'The number of records exceeds the limit (%s). Please narrow it down with the display filter.',
            'kanban_partial' => 'Only the %s cards already loaded are shown (of %s). Switch back to the original view to load more and to see whole-table figures.',
            'kanban_wip_full' => '"%s" is at its WIP limit (%s). Continue anyway?',
            'kanban_wip_blocked' => '"%s" is at its WIP limit (%s) and cannot take another card.',
            'kanban_search_capped' => 'Too many matches to show: each column stops at the first %s. Please narrow the keyword.',
            'kanban_move_error' => 'Failed to update. Please reload the page.',
            'kanban_moved' => 'Moved %s to "%s"',
            'kanban_inline_saved' => 'Saved %s',
            'kanban_view_saved' => 'Saved the view "%s". It was created as your own view and can be opened from the view list.',
            'kanban_blank_filtered' => 'No card matches the filter. Change it, or reset the board.',
            'kanban_created' => 'Added %s',
            'kanban_assigned' => 'Changed the assignee of %s records',
            'kanban_bulk_moved' => 'Changed %s records to "%s"',
        ],
    ...
    'menu' => [
        ...
        'system_definitions' => [
            ...
            'menu' => 'Menu',
            'template' => 'Template',
            'cell_style_preset' => 'Cell style presets',
            'backup' => 'Backup',
            'loginuser' => 'LoginUser',
            'notify' => 'Notify',
    ...
    'operation_log' => [
        ...
        'schedule_all' => 'All',
        'automatic_week' => 'Run day of week',
        'automatic_month' => 'Run month',
        'automatic_day' => 'Run day',
        'automatic_hour' => 'Run hour',
        'automatic_minute' => 'Run minute',
        'automatic_week_help' => 'If not specified, runs regardless of the day of week.',
        'automatic_month_help' => 'If not specified, runs regardless of the month.',
        'automatic_day_help' => 'If not specified, runs regardless of the day. If both day-of-week and day are specified, runs when both conditions are met.',
