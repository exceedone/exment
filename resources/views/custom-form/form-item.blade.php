        ...
        <div class="options" style="display:{{!boolval($suggest) ? 'block' : 'none'}};">
            <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <span class="control-label col-sm-4">{{exmtrans('custom_form.view_only')}}</span>
                    ...
                    <div class="form-group">
                        <span class="control-label col-sm-4">{{exmtrans('custom_form.hidden')}}</span>
                        <div class="col-sm-8" style="padding-top:4px;">
                    ...
                    <div class="form-group">
                            <span class="control-label col-sm-4">{{exmtrans('custom_form.text')}}</span>
                            <div class="col-sm-8">
                    ...
                    <div class="form-group">
                            <span class="control-label col-sm-4">{{exmtrans('custom_form.html')}}</span>
                            <div class="col-sm-8">
