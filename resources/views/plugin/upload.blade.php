<div class="box box-info">
    ...
    <form class="" method="post" action="{{ admin_url('plugin') }}" enctype="multipart/form-data">
        ...
        <div class="box-footer">
            ...
            <button type="submit" class="btn btn-twitter btn-upload submit_disabled" data-loading-text="<i class='fa fa-spinner fa-spin '></i> {{trans('admin.upload')}}">{{trans('admin.upload')}}</button>
        </div>
