...
<label for="{{$id['status_from']}}" class="{{$viewClass['label']}} control-label">{{$label}}</label>
    ...
    <div class="{{$viewClass['field']}}">
        ...
        <label for="{{$id['action_name']}}" class="control-label asterisk">アクション名</label>
        ...
        <label for="{{$id['status_from']}}" class="control-label asterisk">実行前ステータス</label>
        ...
        <label for="{{$id['status_to']}}" class="control-label asterisk">実行後ステータス</label>
